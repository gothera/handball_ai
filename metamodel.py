...
from loss import HRNetLoss, create_heatmaps
from model import HRNetHeatmap

from transforms import HRNetPredictionTransform
...
class HRNetMetaModel(Model):
    ...
    def __init__(self, params):
        ...
        if 'prediction_transform' in self.params: self.prediction_transform = HRNetPredictionTransform(self.params['prediction_transform']['size'])
